...
from .views import RegisterView, LoginView, LogoutView, SendFriendRequestView, AcceptFriendRequestView, UpdateUserView, DeleteFriendView#, DeclineFriendRequestView)
